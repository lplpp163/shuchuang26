...
Round 14把評審第一分鐘改成可見、可聽、可驗證的三幕：具名進度、白天開門／夜晚休息兩個世界、四段角色聲音、內容不同且依序亮起的三棒，以及零資料可發現的五個生活題材。下列是目前可採信證據；Round 13與Round 12數字只作歷史快照。

- 格式72檔無漂移、`flutter analyze` 0問題、Flutter測試137／137、相對路徑Web build通過；Chromium與Edge的App各8／8。
...
- 正式計畫書PDF／DOCX皆18頁：PDF 597,465 bytes／`A7748301B7568A8561F3630BC2B74021A4071E9CE07B16D4CFA61A09B088E895`；DOCX 986,650 bytes／`7AC25A49B1E43924E77AC41AC12ED02462DD471C6F3A6E031FC2D81536A2491B`。22頁教師包為594,647 bytes／`4422A71CC412660B6705B2853963C77DBF8183E7E8EDC7A8FC340CCACBC4C97A`；兩者QA通過。
- 正式影片173.900秒、53,423,717 bytes／`9BBB48FBC0A6215EAA09A34B693550E7E34BF2FEF7DF0B0B817F64919CEA373B`；720p預覽21,436,942 bytes／`3F2A385C3ABDD3ADE46D005466AD8C12FD074169DA38AFF3DA54E69FB2C35B0D`。15／15場景與17／17語音窗PASS，驗證JSON為`701CF6994C409D9FC4B1841A8568E134BC317DCB298C25FA622E3AA4E38E65DD`。
